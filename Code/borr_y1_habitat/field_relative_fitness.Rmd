...
```{r}
multi_panel_gg<-(field_int_rate_grow_gg+theme(legend.position = c(0.9,1)))/
...
ggsave(plot=multi_panel_gg,file="/Users/Miranda/Documents/Education/UC Santa Cruz/Dittrichia/Dittrichia_Analysis/figures/multi_panel_gg.png",width=15,height=25,units="cm",dpi=800)
...
Let's manipulate the shade data!
...
Let's manipulate the water data!
