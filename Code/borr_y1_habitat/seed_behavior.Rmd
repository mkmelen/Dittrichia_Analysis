...
```{r}
fakedata1<-data.frame(Habitat=c("Vegetated","Roadside","Vegetated","Roadside"),Treatment=c("Construction Soil","Field Soil","Field Soil","Construction Soil"),DaysToGerm=c(0),type=c("fake")) #we want the graph to start at zero, but the data starts on day 2, so here we create fake data for the line to use
...
germ_rate1_gg<-ggplot(germ_rate1,
  ...
  scale_size_manual(values=c(0,3),
                    guide="none")+
  scale_color_manual(values=c("gray58","gray58","forestgreen","forestgreen"))+
  labs(y="Proportion Germinated",
       color="Habitat/Treatment",
       shape="Habitat/Treatment")
germ_rate1_gg
...
germ_rate2_gg<-ggplot(germ_rate2)+
  ...
  scale_shape_manual(values=c(1, 19, 1, 19, 0, 15, 0, 15, # 8 shape numbers in this array
                                ...
                                6, 25, 6, 25, 3, 12, 3, 12,
                                4, 13, 4, 13, 8, 11, 8, 11))+
  scale_color_manual(values=rep(c("forestgreen","forestgreen","gray58","gray58"),
                                times=8))+
  labs(y="Proportion Germinated",
       color="Population/Treatment",
       shape="Population/Treatment")
...
germ_int_site_gg<-ggplot(data=mydata_site_sum,
  ...
  scale_shape_manual(values=c(19, 19, 15, 15,
                               ...
                               25, 25, 3, 3,
                               4, 4, 8, 8))+
  scale_color_manual(values=rep(c("gray58","forestgreen"),times=16))+
