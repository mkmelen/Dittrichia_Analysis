...
comp_int_all<-log_mydata%>% 
  group_by(Soil,Habitat)%>%
...
comp_int_all_gg<-ggplot(data=comp_int_all,
                        aes(x=factor(Soil),
                            y=Mean,
                            shape=Habitat,
                            group=Habitat,
  ...
  geom_point(size=3,
             position=pd)+
  scale_color_manual(values=c("gray58","forestgreen"))+
...
#ggsave(plot=comp_int_all_gg,file="/Users/Miranda/Documents/Education/UC Santa Cruz/Dittrichia/Dittrichia_Analysis/figures/comp_int_all_gg.png",width=25,height=20,units="cm",dpi=800)
```
